...
export class UserRouter{
    ...
    private initializeRoutes(): void {
        ...
        this.router.patch('/profile' ,this.userMiddleware.verifyToken, this.validatorMiddleware.uploadProfileImage,uploader("IMG", "/images").single("file"),  this.userController.uploadProfileImage)
